        ...
        >
          <div className="flex text-white justify-center">
            ...
            <div className="w-2/3 text-center space-y-4">
              ...
              <p>
              I am a proficient and versatile software developer with expertise in Java,
               MySQL, Spring, JavaScript, and HTML. My foundation in Java allows me to design 
               and implement robust backend solutions, leveraging the power of the language and the 
               Spring framework for scalable and efficient applications 
              </p>
